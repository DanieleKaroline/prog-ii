...
document.addEventListener("DOMContentLoaded", function() {  
    ...
    bt3.addEventListener("click", seqCor)

    const bt4 = document.getElementById("bt4")
    bt4.addEventListener("click", addBt);
    ...
    function seqCor(){
        const btn = document.getElementById('bt3');
        const colors = ['#9872ab','cyan', 'red', 'purple', 'yellow', 'gray', 'blue'];
